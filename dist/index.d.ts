...
declare type GliderOptions = Pick<GliderProps, 'arrows' | 'dots' | 'slidesToShow' | 'slidesToScroll' | 'itemWidth' | 'exactWidth' | 'scrollLock' | 'scrollLockDelay' | 'resizeLock' | 'responsive' | 'rewind' | 'scrollPropagate' | 'draggable' | 'dragVelocity' | 'duration' | 'skipTrack' | 'type'>;
